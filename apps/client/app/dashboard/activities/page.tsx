  ...
  return (
    <>
      <div className="w-full max-w-[300px] text-sm">
        <h1 className="font-semibold text-lg text-nowrap">Activity Center</h1>
      ...
      <section className="w-full text-sm flex gap-2 flex-wrap mb-5">
        ...
        <section className="w-[300px] flex-grow">
          <article className="w-full text-sm mt-4 p-4 rounded-lg bg-[#FFFFFF] dark:bg-[#0E0E23] flex-grow">
            <h2 className="font-semibold text-lg mb-1">Account Activities</h2>
            <p className="text-[gray]">
              Track your account API calls. We ony keep these the records per
              day, after 24 hours these records are reset{' '}
            </p>
        ...
        <section className="w-[300px] flex-grow">
          ...
          <article className="w-full text-sm mt-4 py-6 px-4 rounded-lg bg-[#FFFFFF] dark:bg-[#0E0E23] ">
            ...
            <div className="mt-4">
              {/* <h2 className="font-semibold text-lg">02 Custom Domains</h2> */}
              <div className="flex justify-between items-center mt-3">
          ...
          <article className="w-full text-sm mt-4 py-6 px-4 rounded-lg bg-[#FFFFFF] dark:bg-[#0E0E23] ">
            ...
            <div className="mt-4">
              <h2 className="font-semibold text-lg">
                {data?.data[0]?.GmailAccounts.length || '00'} Gmail Accounts
              </h2>
              <div className="flex justify-between items-center mt-3">
                <p className="text-gray-500">
                  {totalEmailsSentByGmail} emails sent
                </p>
